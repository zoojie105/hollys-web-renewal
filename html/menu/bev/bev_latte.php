...
<main id="main">
    ...
    <div class="tab_wrap">
        ...
        <ul>
            ...
            <li class="tab1"><a href="#">라떼·초콜릿</a></li>
...
<aside class="locate">
    ...
    <ul>
        ...
        <li class="locate4"><a href="#">라떼·초콜릿</a></li>

    </ul>
</aside>

<section class="bev_latte">
    <h2 class="blind">라떼·초콜릿</h2>
    <div class="latte1">
    <ul>
        <li class="latte1_1">
            <ul>
        ...
        <li class="latte1_2">
            <ul>
            <li><a href="holly_milktea.php">밀크티라떼</a></li>
            </ul>
        </li>
        <li class="latte1_3">
            <ul>
