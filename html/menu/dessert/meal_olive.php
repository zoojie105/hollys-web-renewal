...
<main id="main">
    ...
    <div class="meal11_wrap">
        ...
        <section class="meal11">
        <h2>올리브 베이컨 치아바타</h2>
        <p class="txt1">Olive Bacon Ciabatta</p>
        <p class="txt2">쫄깃한 올리브치아바타를 감자와 베이컨으로 채운 담백한 샌드위치</p>
    
        <dl class="info">
        <dt>제품 영양정보</dt>
            <dd class="info_txt">
                <ul>
                <li class="info1">총 중량 198g</li>
                <li class="info2">1회 제공량 198g 기준</li>
                </ul>
            </dd>
            <dd>
                <table>
...
<div class="other_wrap de">
    ...
    <h2>다른 제품 둘러보기</h2>
    <ul class="other1">
        <li class="other9_3"><a href="#">올리브 베이컨<br>치아바타</a></li>
