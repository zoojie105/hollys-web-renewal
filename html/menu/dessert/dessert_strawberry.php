...
<main id="main">
    ...
    <div class="de4_wrap">
        ...
        <section class="de4">
        <h2>딸기 생크림</h2>
        <p class="txt1">Strawberry Fresh Cream Cake</p>
        <p class="txt2">상큼한 딸기 생크림과 하얀 생크림이 어우러진 케이크</p>
    
        <dl class="info">
        <dt>제품 영양정보</dt>
            <dd class="info_txt">
                <ul>
                <li class="info1">총 중량 112g</li>
                <li class="info2">1회 제공량 112g</li>
                </ul>
            </dd>
            <dd>
                <table>
...
<div class="other_wrap de">
    ...
    <ul class="other1">
        ...
        <li class="other3_2"><a href="#">딸기 생크림</a></li>
