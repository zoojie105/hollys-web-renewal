...
<div class="header_bottom">
        <h1><a href="/html/index.php">할리스 커피</a></h1>
...
<div class="smo6_wrap">
    <aside class="locate">
        ...
        <ul>
            ...
            <li class="locate4"><a href="bev_smo.php">스무디·주스</a></li>
        </ul>
    </aside>
    ...
    <h2>청포도케일
        착즙주스</h2>
    <p class="txt1">Green Grape Kale Juice</p>
    <p class="txt2">녹색 과일 청포도와 녹색 채소 케일이 만나 달콤한 채소과일 주스</p>
    
    <dl class="info">
        <dt>제품 영양정보</dt>
        <dd class="info1">1회 제공량</dd>
        <dd class="info1">Regular</dd>
...
<div class="other_wrap bev">
    ...
    <ul class="other1">
        ...
        <li class="other11_4"><a href="#">청포도케일<br>착즙주스</a></li>
        ...
        <li class="other5_3"><a href="#">페퍼민트</a></li>
