...
<main id="main">
    ...
    <div class="meal15_wrap">
        ...
        <section class="meal15">
        <h2>크로크무슈</h2>
        <p class="txt1">Mushroom Soup Bowl</p>
        <p class="txt2">쫄깃한 바게트 볼 속에 담백한 양송이 수프를 담아 부드러운 빵과 함께 먹는 <br>담백한 수프볼</p>
    
        <dl class="info_br">
        <dt>제품 영양정보</dt>
            <dd class="info_txt">
                <ul>
                <li class="info1">총 중량 412g</li>
                <li class="info2">1회 제공량 206g 기준</li>
                </ul>
            </dd>
            <dd class="agy">
                <ul>
                <li>알레르기 유발요인: 밀, 우유, 대두, 돼지고기, 닭고기</li>
...
<div class="other_wrap de">
    ...
    <h2>다른 제품 둘러보기</h2>
    <ul class="other1">
        <li class="other10_3"><a href="#">머쉬룸 수프볼</a></li>
