...
<div class="tea10_wrap">
    <aside class="locate">
        ...
        <ul>
            ...
            <li class="locate4"><a href="bev_tea.php">티(TEA)</a></li>
        </ul>
    </aside>
    ...
    <p class="txt1">Green Tea</p>
    <p class="txt2">고소한 감칠맛과 부드러운 목넘김이 좋은 땅끝 마음 해남에서 재배한 녹차<br>(유기농 녹차잎 사용)</p>
    
    <dl class="info">
        <dt>제품 영양정보</dt>
        <dd class="info1">1회 제공량</dd>
        <dd class="info2">Regular</dd>
        <dd class="info3">354ml 기준</dd>
    </dl>
...
<ul class="other1">
    ...
    <li class="other5_2"><a href="#">해남 녹차</a></li>
    ...
    <li class="other9_4"><a href="smo_mango.php">하나가득 애플<br>망고 스무디</a></li>
    ...
    <li class="other1_1"><a href="latte_mango.php">애플망고<br>코코넛 라떼</a></li>
    <li class="other1_2"><a href="latte_greentea.php">그린티라떼</a></li>
    <li class="other1_3"><a href="latte_milktea.php">밀크티라떼</a></li>
    <li class="other1_4"><a href="latte_sweet.php">우리 고구마라떼</a></li>

    <li class="other2_1"><a href="latte_belgian.php">리얼 벨지안<br>초코</a></li>
    ...
    <li class="other3_2"><a href="tea_hibiscus.php">히비스커스<br>후르츠</a></li>
