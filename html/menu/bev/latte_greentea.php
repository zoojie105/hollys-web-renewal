...
<div class="latte2_wrap">
    ...
    <section class="latte2">
    <h2>그린티라떼</h2>
    <p class="txt1">Green Tea Latte</p>
    <p class="txt2">100% 국내산 녹차와 우유를 블렌딩해 고소하고 쌉싸름한 맛과 라이트한 음료</p>
...
<div class="other_wrap bev">
    ...
    <h2>다른 제품 둘러보기</h2>
    <ul class="other1">
        <li class="other1_2"><a href="#">그린티라떼</a></li>
