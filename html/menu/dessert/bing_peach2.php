    ...
    <div class="bing2_wrap">
        ...
        <section class="bing2">
            ...
            <dt>제품 영양정보</dt>
                <dd class="info_txt">
                    <ul>
                    <li class="info1">총 중량 649g</li>
                    <li class="info2">1회 제공량 325g</li>
                    </ul>
                </dd>
                <dd class="agy">
                    <ul>
                    <li>알레르기 유발요인: 우유, 복숭아</li>
                    <li>※ 식품위생법 표시기준에 의거하여 알레르기 표시항목에 한해서만표기함</li>
                    </ul>
                </dd>
                <dd>
                    <table>
...
<div class="other_wrap de">
    ...
    <ul class="other1">
        ...
        <li class="other1_2"><a href="#">2인) 피치딸기빙수</a></li>
