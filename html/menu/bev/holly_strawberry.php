...
<div class="holy1_wrap">
    <aside class="locate">
        ...
        <ul>
            ...
            <li class="locate4"><a href="bev_holly.php">할리치노</a></li>
        </ul>
    </aside>
    
    <section class="holy1">
    <h2>딸기 치즈케익 할리치노</h2>
    <p class="txt1">Strawberry Cheese Cake Hollyccino</p>
    <p class="txt2">치즈케익맛 아이스블렌디드 음료에 상큼한 딸기를 토핑한 할리스 시그니처 메뉴</p>
...
<div class="other_wrap bev">
    ...
    <ul class="other1">
        ...
        <li class="other7_2"><a href="#">딸기 치즈케익 할리치노</a></li>
