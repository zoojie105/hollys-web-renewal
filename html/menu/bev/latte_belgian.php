...
<div class="latte5_wrap">
    ...
    <section class="latte5">
    <h2>리얼 벨지안 초코</h2>
    <p class="txt1">Real Belgian Chocolate</p>
    <p class="txt2">카카오 59.5%의 벨지안 다크초콜릿을 녹여 만든 <br>할리스커피 시그니처 초콜릿 음료</p>
...
<div class="other_wrap bev">
    ...
    <h2>다른 제품 둘러보기</h2>
    <ul class="other1">
        <li class="other2_1"><a href="#">리얼 벨지안<br>초코</a></li>
