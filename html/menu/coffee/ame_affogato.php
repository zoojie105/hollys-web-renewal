...
<article class="locate">
    ...
    <section class="coffee14">
    <h2>아포카토</h2>
    <ul>
    <li class="txt1">Affogato</li>
    <li class="txt2">바닐라 아이스크림과 리스트레또 더블샷이 어우러져 부드럽고<br>진한 맛의 아포가토</li>
    </ul>
    <dl class="info">
        <dt>제품 영양정보</dt>
        <dd class="info1">1회 제공량</dd>
        <dd class="info3">150ml 기준</dd>
    </dl>
...
<ul class="other1">
    ...
    <li class="other4_3"><a href="#">아포카토</a></li>
