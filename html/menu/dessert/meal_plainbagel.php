...
<main id="main">
    ...
    <div class="meal17_wrap">
        ...
        <section class="meal17">
        <h2>플레인 베이글 & 크림치즈</h2>
        <p class="txt1">Plain Bagel</p>
        <p class="txt2">찰지면서도 질기지 않은 보송보송함이 살아있는 할리스 베이글</p>
...
<div class="other_wrap de">
    ...
    <ul class="other1">
        ...
        <li class="other10_4"><a href="#">플레인 베이글 &<br>크림치즈</a></li>
