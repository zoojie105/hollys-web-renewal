...
<main id="main">
    ...
    <div class="meal13_wrap">
        ...
        <section class="meal13">
        <h2>치킨 크림 리조또</h2>
        <p class="txt1">Chicken Cream Risotto</p>
        <p class="txt2">닭가슴살, 버섯, 베이컨이 큼지막하게 토핑된 부드러운 풍미의 크림 리조또</p>
        ...
        <dt>제품 영양정보</dt>
            ...
            <dd class="agy">
                <ul>
                <li>알레르기 유발요인: 밀, 우유, 대두, 돼지고기, 닭고기, 소고기</li>
...
<div class="other_wrap de">
    ...
    <ul class="other1">
        ...
        <li class="other10_1"><a href="#">치킨 크림 리조또</a></li>
