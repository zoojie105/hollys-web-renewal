...
<main id="main">
    ...
    <div class="de12_wrap">
        ...
        <section class="de12">
        <h2>초코 빅카롱</h2>
        <p class="txt1">chocolate Macaron</p>
        <p class="txt2">진하고 부드러운 초코 크림이 샌드된 빅카롱</p>
    
        <dl class="info">
        <dt>제품 영양정보</dt>
            <dd class="info_txt">
                    <ul>
                    <li class="info1">총 중량 40g</li>
                    <li class="info2">1회 제공량 40g 기준</li>
                    </ul>
            </dd>
            <dd>
                <table>
...
<div class="other_wrap de">
    ...
    <ul class="other1">
        ...
        <li class="other5_2"><a href="#">초코 빅카롱</a></li>
