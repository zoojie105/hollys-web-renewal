...
<article class="locate">
    ...
    <ul>
        ...
        <li class="locate4"><a href="coffee_ame.php">아메리카노</a></li>
    </ul>
</article>

    <section class="coffee13">
    <h2>아메리카노</h2>
    <ul>
    <li class="txt1">Caffe Americano</li>
    <li class="txt2">진한 에스프레소의 맛과 향을 부드럽게 즐길 수 있는 아메리칸 스타일의 커피</li>
    </ul>
    <dl class="info">
        <dt>제품 영양정보</dt>
...
<h2>다른 제품 둘러보기</h2>
<ul class="other1">
    <li class="other4_2"><a href="#">아메리카노</a></li>
