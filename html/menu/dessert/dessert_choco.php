...
<main id="main">
    ...
    <div class="de11_wrap">
        ...
        <section class="de11">
        <h2>아메리칸 초콜릿 청크 쿠키</h2>
        <p class="txt1">American Chocolate Chunk Cookie</p>
        <p class="txt2">리얼 초콜릿 청크가 풍부하게 들어간 쫀득한 식감의 아메리칸 스타일 쿠키</p>
        </section>
    </div>
...
<div class="other_wrap de">
    ...
    <ul class="other1">
        ...
        <li class="other5_1"><a href="#">아메리칸 초콜릿<br>청크쿠키</a></li>
