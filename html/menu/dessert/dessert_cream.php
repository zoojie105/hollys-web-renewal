...
<main id="main">
    ...
    <div class="de1_wrap">
        ...
        <section class="de1">
        <h2>크림치즈비스켓 & 딸기잼</h2>
        <p class="txt1">Cream Cheese Biscuit & Strawberry Jam</p>
        <p class="txt2">버터향이 가득한 촉촉한 비스켓 속 크림치즈가 들어간 풍미 가득한 비스켓</p>
        <ul class="tag">
            <li class="new">NEW</li>
        </ul>
        ...
        <dt>제품 영양정보</dt>
            <dd class="info_txt">
                <ul>
                <li class="info1">총 중량 92g</li>
                <li class="info2">1회 제공량 92g</li>
                </ul>
            </dd>
            <dd class="agy">
                <ul>
                <li>알레르기 유발요인: 밀, 우유, 대두</li>
...
<div class="other_wrap de">
    ...
    <ul class="other1">
        ...
        <li class="other2_3"><a href="#">크림치즈비스켓<br>& 딸기잼</a></li>
