...
<main id="main">
    ...
    <div class="meal10_wrap">
        ...
        <section class="meal10">
        <h2>페스토 햄 모짜렐라</h2>
        <p class="txt1">Pesto Ham Mozzarella</p>
        <p class="txt2">터키햄과 모짜렐라치즈를 두둑하게 채운 대중적인 샌드위치</p>
    
        <dl class="info">
        <dt>제품 영양정보</dt>
            <dd class="info_txt">
                <ul>
                <li class="info1">총 중량 185g</li>
                <li class="info2">1회 제공량 185g 기준</li>
                </ul>
            </dd>
            <dd>
                <table>
...
<div class="other_wrap de">
    ...
    <ul class="other1">
        ...
        <li class="other9_2"><a href="#">패스토 햄 모짜렐라</a></li> 
