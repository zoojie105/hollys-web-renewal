...
<main id="main">
    ...
    <div class="bing6_wrap">
        ...
        <ul>
            ...
            <li class="locate4"><a href="../dessert/de_bing.php">빙수</a></li>
        </ul>
        </article>
    
        <section class="bing6">
        <h2>2인)우리눈꽃팥빙수</h2>
        <p class="txt1">Red Bean Iced Flakes</p>
        <p class="txt2">부드러운 우유얼음에 국내산 팥, 바삭한 그래놀라, 쫄깃한 인절미와<br>바닐라 아이스크림이 어우러진 전통빙수</p>
        <ul class="tag">
            <li class="new">NEW</li>
            <li class="n_season">SEASONAL MENU</li>
        </ul>
        ...
        <dt>제품 영양정보</dt>
            <dd class="info_txt">
                <ul>
                <li class="info1">총 중량 626g</li>
                <li class="info2">1회 제공량 313g</li>
                </ul>
            </dd>
            <dd class="agy">
                <ul>
                <li>알레르기 유발요인: 우유, 땅콩, 메밀, 밀, 대두, 호두</li>
                <li>※ 식품위생법 표시기준에 의거하여 알레르기표시항목에한해서만표기함</li>
                </ul>
            </dd>
            <dd>
                <table>
...
<div class="other_wrap de">
    ...
    <ul class="other1">
        ...
        <li class="other2_2"><a href="#">2인) 우리눈꽃<br>팥빙수</a></li>
        ...
        <li class="other6_3"><a href="dessert_chipscone.php">초코칩 스콘</a></li>
