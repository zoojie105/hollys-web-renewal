...
<div class="latte8_wrap">
    ...
    <section class="latte8">
    <h2>민트초코</h2>
    <p class="txt1">Mint Chocolate</p>
    <p class="txt2">초콜릿과 민트향이 만나 달콤하면서도 청량감 있는 초코음료</p>
...
<div class="other_wrap bev">
    ...
    <ul class="other1">
        ...
        <li class="other2_4"><a href="#">민트초코</a></li>
