...
<main id="main">
    ...
    <div class="de16_wrap">
        ...
        <section class="de16">
        <h2>허니바게트볼</h2>
        <p class="txt1">Honey Baguette Bowl</p>
        <p class="txt2">겉은 바삭 속은 쫄깃한 바게트 속에 꿀과 버터가 녹아있는 부드럽고 달콤한 허니브레드</p>
    
        <dl class="info">
        <dt>제품 영양정보</dt>
            <dd class="info_txt">
                    <ul>
                    <li class="info1">총 중량 255g</li>
                    <li class="info2">1회 제공량 128g 기준</li>
                    </ul>
            </dd>
            <dd class="agy">
                    <ul>
                    <li>알레르기 유발요인: 밀, 계란, 우유, 대두, 소고기</li>
                    <li>※ 식품위생법 표시기준에의거하여레르기표시항목에한해서만표기함</li>
                    </ul>
            </dd>
            <dd>
                <table>
...
<div class="other_wrap de">
    ...
    <ul class="other1">
        ...
        <li class="other6_2"><a href="#">허니바게트볼</a></li>
