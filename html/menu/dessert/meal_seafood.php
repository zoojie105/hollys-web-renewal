...
<main id="main">
    ...
    <div class="meal12_wrap">
        ...
        <section class="meal12">
        <h2>스파이시 씨푸드 리조또</h2>
        <p class="txt1">Spicy Seafood Risotto</p>
        <p class="txt2">탱글탱글한 새우와 오징어살이 토핑된 매콤한 토마토베이스의 리조또</p>
    
        <dl class="info">
        <dt>제품 영양정보</dt>
            <dd class="info_txt">
                <ul>
                <li class="info1">총 중량 241g</li>
                <li class="info2">1회 제공량 241g 기준</li>
                </ul>
            </dd>
            <dd class="agy">
                <ul>
                <li>알레르기 유발요인: 밀, 우유, 대두, 토마토, 닭고기, 쇠고기, 새우, 오징어</li>
...
<div class="other_wrap de">
    ...
    <ul class="other1">
        ...
        <li class="other9_4"><a href="#">스파이시 씨푸드<br>리조또</a></li>
