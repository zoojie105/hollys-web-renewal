...
<main id="main">
    ...
    <div class="bing5_wrap">
        ...
        <p class="txt2">부드러운 우유얼음에 국내산 팥, 바삭한 그래놀라, 쫄깃한 인절미와 바닐라 아이스크림이 어우러진 전통빙수</p>
        <ul class="tag">
            <li class="new">NEW</li>
        ...
        <dl class="info_br">
            ...
            <dd class="info_txt">
                <ul>
                <li class="info1">총 중량 326g</li>
                <li class="info2">1회 제공량 326g</li>
                </ul>
            </dd>
            <dd class="agy">
                <ul>
...
<div class="other_wrap de">
    ...
    <h2>다른 제품 둘러보기</h2>
    <ul class="other1">
        <li class="other2_1"><a href="#">1인) 우리눈꽃<br>팥빙수</a></li>
