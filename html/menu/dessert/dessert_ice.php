...
<main id="main">
    ...
    <div class="de3_wrap">
        ...
        <section class="de3">
        <h2>곰표 아이스크림 크로플</h2>
        <p class="txt1">Gompyo Croffle with Ice Cream</p>
        <p class="txt2">곰표 밀가루로 만든 겉바속촉, 달달하고 시원한 아이스크림 크로플</p>
        <ul class="tag">
            <li class="new">NEW</li>
        ...
        <dt>제품 영양정보</dt>
            <dd class="info_txt">
                <ul>
                <li class="info1">총 중량 173g</li>
                <li class="info2">1회 제공량 173g</li>
                </ul>
            </dd>
            <dd class="agy">
                <ul>
...
<div class="other_wrap de">
    ...
    <h2>다른 제품 둘러보기</h2>
    <ul class="other1">
        <li class="other3_1"><a href="#">표곰이 아이스크림<br>크로플</a></li>
