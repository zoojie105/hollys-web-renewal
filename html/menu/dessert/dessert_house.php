...
<div class="de2_wrap">
    ...
    <section class="de2">
    <h2>표곰이 크림치즈 하우스</h2>
    <p class="txt1">Gompyo Cream Cheese House Cake</p>
    <p class="txt2">폭신한 다쿠아즈 위에 부드러운 치즈크림과<br>상큼한 딸기 콩포트가 어우러진 이글루 모양의 케이크</p>
    <ul class="tag">
        <li class="new">NEW</li>
    ...
    <dt>제품 영양정보</dt>
        <dd class="info_txt">
            <ul>
            <li class="info1">총 중량 113g</li>
            <li class="info2">1회 제공량 113g</li>
            </ul>
        </dd>
        <dd class="agy">
            <ul>
            <li>알레르기 유발요인:  밀, 계란, 우유, 대두</li>
            <li>※ 식품위생법 표시기준에 의거하여레르기표시항목에한해서만표기함</li>
            </ul>
        </dd>
        <dd>
            <table>
...
<div class="other_wrap de">
    ...
    <ul class="other1">
        ...
        <li class="other2_4"><a href="#">표곰이 크림치즈<br>하우스</a></li>
