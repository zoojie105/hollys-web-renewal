...
<main id="main">
    ...
    <div class="meal4_wrap">
        ...
        <section class="meal4">
        <h2>에그 마요</h2>
        <p class="txt1">Egg Mayo Sandwich</p>
        <p class="txt2">계란 2알을 그대로 으깨 푹신한 식빵에 담아낸 가성비 좋은 수제 콜드 샌드위치</p>
    
        <dl class="info">
        <dt>제품 영양정보</dt>
            <dd class="info_txt">
                <ul>
                <li class="info1">총 중량 270g</li>
                <li class="info2">1회 제공량 270g 기준</li>
                </ul>
            </dd>
            <dd>
                <table>
...
<div class="other_wrap de">
    ...
    <ul class="other1">
        ...
        <li class="other7_4"><a href="#">에그 마요</a></li>
