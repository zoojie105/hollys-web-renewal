...
<main id="main">
    ...
    <div class="de7_wrap">
        ...
        <section class="de7">
        <h2>리얼벨지안 초코 케익</h2>
        <p class="txt1">Real Belgian Chococake</p>
        <p class="txt2">벨기에산 다크초콜릿 베이스의 진한 케익에 포요틴(크런치)과 <br>아몬드로 식감을 더한 진한 초코케익</p>
    
        <dl class="info_br">
            <dt>제품 영양정보</dt>
                <dd class="info_txt">
                    <ul>
                    <li class="info1">1회 제공량당</li>
                    <li class="info2">총 1회 제공량 162g 기준</li>
                    </ul>
                </dd>
                <dd class="agy">
                    <ul>
...
<div class="other_wrap de">
    ...
    <ul class="other1">
        ...
        <li class="other4_1"><a href="#">리얼벨지안<br>초코케익</a></li>
