...
<main id="main">
    ...
    <div class="de5_wrap">
        ...
        <section class="de5">
        <h2>블루베리 치즈 라운드</h2>
        <p class="txt1">Blueberry Cheese Round Cake</p>
        <p class="txt2">상큼한 블루베리 치즈케익과 부드러운 레어 치즈가 어우러진 케익</p>
...
<div class="other_wrap de">
    ...
    <ul class="other1">
        ...
        <li class="other3_3"><a href="#">BC블루베리 치즈<br>라운드</a></li>
