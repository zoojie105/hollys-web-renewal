...
<main id="main">
    ...
    <div class="meal6_wrap">
        ...
        <section class="meal6">
        <h2>수플레 오믈렛 라이스</h2>
        <p class="txt1">Souffle Omelet Rice</p>
        <p class="txt2">부드럽고 포슬한 식감의 오믈렛과 아라비아따 소스로 구성된 오믈렛 라이스</p>
        <ul class="tag">
            <li class="season">SEASONAL MENU</li>
        </ul>
        ...
        <dt>제품 영양정보</dt>
            <dd class="info_txt">
                <ul>
                <li class="info1">총 중량 243g</li>
                <li class="info2">1회 제공량 243g 기준</li>
                </ul>
            </dd>
            <dd>
                <table>
...
<div class="other_wrap de">
    ...
    <h2>다른 제품 둘러보기</h2>
    <ul class="other1">
        <li class="other8_2"><a href="#">수플레 오믈렛<br>라이스</a></li>
