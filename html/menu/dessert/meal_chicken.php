...
<div class="meal8_wrap">
    ...
    <ul>
        ...
        <li class="locate4"><a href="de_meal.php">샌드위치·식사</a></li>
    </ul>
    </article>

    <section class="meal8">
    <h2>바삭 불고기 & 트리플 치즈 치킨 퀘사디아</h2>
    <p class="txt1">Bulgogi & Triple Cheese Chicken Quesadilla</p>
    <p class="txt2">소고기로 만든 한국인의 대표음식 불고기 퀘사디아와 체다, 고다, 모짜렐라 세 가지 치즈에 달콤한 토마토 소스, 치킨이 들어간 퀘사디아</p>
    ...
    <dt>제품 영양정보</dt>
        <dd class="info_txt">
            <ul>
            <li class="info1">총 중량 180g</li>
            <li class="info2">1회 제공량 180g 기준</li>
            </ul>
        </dd>
        <dd>
            <table>
...
<div class="other_wrap de">
    ...
    <ul class="other1">
        ...
        <li class="other8_4"><a href="#">바삭 불고기&트리플<br>치즈 치킨 퀘사디아</a></li>
