...
<div class="holy5_wrap">
    ...
    <section class="holy5">
    <h2>민트초코 할리치노</h2>
    <p class="txt1">Mint Chocolate Hollyccino</p>
    <p class="txt2">초콜릿에 민트향을 더해 얼음과 블렌딩한 청량감 있는 슬러쉬 음료</p>
...
<div class="other_wrap bev">
    ...
    <ul class="other1">
        ...
        <li class="other8_2"><a href="#">민트초코<br>할리치노</a></li>
