...
<div class="holy3_wrap">
    ...
    <section class="holy3">
    <h2>콜드브루 모카 할리치노</h2>
    <p class="txt1">ColdBrew Mocha Hollyccino</p>
    <p class="txt2">콜드브루에 우유와 초콜릿소스를 더한 달콤 쌉싸름한 할리치노</p>
...
<div class="other_wrap bev">
    ...
    <ul class="other1">
        ...
        <li class="other7_4"><a href="#">콜드브루 모카<br> 할리치노</a></li>
