...
<main id="main">
    ...
    <div class="de9_wrap">
        ...
        <section class="de9">
        <h2>뉴욕치즈</h2>
        <p class="txt1">New York Cheesecake</p>
        <p class="txt2">부드럽고 촉촉한 식감과 진한 크림 치즈 맛의 구움 치즈케이크</p>
    
        <dl class="info">
            <dt>제품 영양정보</dt>
                <dd class="info_txt">
                    <ul>
                    <li class="info1">총 중량 122g</li>
                    <li class="info2">1회 제공량 122g 기준</li>
                    </ul>
                </dd>
                <dd class="agy">
                    <ul>
...
<div class="other_wrap de">
    ...
    <h2>다른 제품 둘러보기</h2>
    <ul class="other1">
        <li class="other4_3"><a href="#">뉴욕치즈</a></li>
