...
<div class="coffee9_wrap">
    <section class="coffee9">
    <h2>카라멜 마키아또</h2>
    <ul>
    <li class="txt1">Caramel Macchiato</li>
    <li class="txt2">진한 에스프레소에 바닐라 시럽과 카라멜소스가 더해진 카라멜 커피음료의 대표</li>
    </ul>
    <dl class="info">
        <dt>제품 영양정보</dt>
...
<h2>다른 제품 둘러보기</h2>
<ul class="other1">
    <li class="other3_1"><a href="#">카라멜<br>마키아또</a></li>
