...
<div class="bing1_wrap">
    ...
    <section class="bing1">
    <h2>1인) 피치딸기빙수</h2>
    <p class="txt1">Peach Strawberry Iced Flakes</p>
    <p class="txt2">달콤한 복숭아와 새콤달콤 딸기, 요거트 아이스크림, 화이트펄의 <br>다양한 식감이 매력적인 피치딸기빙수</p>
    <ul class="tag">
        <li class="new">NEW</li>
    ...
    <dl class="info_br">
        <dt>제품 영양정보</dt>
            <dd class="info_txt">
                <ul>
                <li class="info1">총 중량 316g</li>
                <li class="info2">1회 제공량 316g</li>
                </ul>
            </dd>
            <dd class="agy">
                <ul>
                <li>알레르기 유발요인: 우유, 복숭아</li>
                <li>※ 식품위생법 표시기준에 의거하여 알레르기 표시항목에 한해서만 표기함</li>
                </ul>
            </dd>
            <dd>
                <table>
...
<div class="other_wrap de">
    ...
    <h2>다른 제품 둘러보기</h2>
    <ul class="other1">
        <li class="other1_1"><a href="#">1인) 피치딸기빙수</a></li>
