...
<main id="main">
    ...
    <div class="meal5_wrap">
        ...
        <section class="meal5">
        <h2>비프 함박 스테이크</h2>
        <p class="txt1">Beef Hamburger Steak</p>
        <p class="txt2">호주산 소고기를 넣어 직화로 구운 함박 스테이크</p>
        <ul class="tag">
        ...
        <dt>제품 영양정보</dt>
            <dd class="info_txt">
                <ul>
                <li class="info1">총 중량 235g</li>
                <li class="info2">1회 제공량 235g 기준</li>
                </ul>
            </dd>
            <dd>
                <table>
...
<div class="other_wrap de">
    ...
    <ul class="other1">
        ...
        <li class="other8_1"><a href="#">비프 함박 스테이크</a></li>
