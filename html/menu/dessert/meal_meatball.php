...
<main id="main">
    ...
    <div class="meal9_wrap">
        ...
        <section class="meal9">
        <h2>미트볼 칠리 치즈</h2>
        <p class="txt1">Meatball Chili Cheese Sandwich</p>
        <p class="txt2">매콤한 칠리소스에 꽉찬 미트볼이 필링된 샌드위치</p>
        <ul class="tag">
        ...
        <dt>제품 영양정보</dt>
            <dd class="info_txt">
                <ul>
                <li class="info1">총 중량 233g</li>
                <li class="info2">1회 제공량 233g 기준</li>
                </ul>
            </dd>
            <dd>
                <table>
...
<div class="other_wrap de">
    ...
    <ul class="other1">
        ...
        <li class="other9_1"><a href="#">미트볼 칠리 치즈</a></li>
