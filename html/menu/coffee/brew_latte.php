...
<article class="locate">
    ...
    <ul>
        ...
        <li class="locate4"><a href="coffee_brew.php.php">콜드브루</a></li>
    </ul>
</article>

    <section class="coffee7">
    <h2>콜드브루 라떼</h2>
    <ul>
    <li class="txt1">Cold Brew Latte</li>
    <li class="txt2">콜드브루 커피의 풍부한 풍미와 우유의 고소함이 더해진 라떼</li>
    </ul>
    <dl class="info">
        <dt>제품 영양정보</dt>
...
<ul class="other1">
    ...
    <li class="other2_3"><a href="#">콜드브루 라떼</a></li>
