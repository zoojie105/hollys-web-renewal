...
<main id="main">
    ...
    <div class="meal14_wrap">
        ...
        <section class="meal14">
        <h2>크로크무슈</h2>
        <p class="txt1">Croque Monsieur</p>
        <p class="txt2">햄과 치즈를 차곡차곡 쌓아 올려 만든 프랑스식 샌드위치로<br> 사르르 녹아내린 모짜렐라 치즈가 입안 가득 풍성한 맛</p>
    
        <dl class="info_br">
        <dt>제품 영양정보</dt>
            <dd class="info_txt">
                <ul>
                <li class="info1">총 중량 160g</li>
                <li class="info2">1회 제공량 160g 기준</li>
                </ul>
            </dd>
            <dd class="agy">
                <ul>
                <li>알레르기 유발요인: 밀, 대두, 우유, 계란, 돼지고기, 소고기</li>
...
<div class="other_wrap de">
    ...
    <ul class="other1">
        ...
        <li class="other10_2"><a href="#">크로크무슈</a></li>
