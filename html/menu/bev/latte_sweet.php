...
<div class="latte4_wrap">
    ...
    <section class="latte4">
    <h2>우리 고구마 라떼</h2>
    <p class="txt1">Sweet Potato Latte</p>
    <p class="txt2">국내산 100% 고구마에 따뜻한 우유를 더해 마음까지 든든한 음료</p>
...
<div class="other_wrap bev">
    ...
    <ul class="other1">
        ...
        <li class="other1_4"><a href="#">우리 고구마라떼</a></li>
