...
<article class="locate">
    ...
    <ul>
        ...
        <li class="locate4"><a href="coffee_brew.php">콜드브루</a></li>
    </ul>
</article>

<section class="coffee8">
<h2>콜드브루</h2>
<ul>
<li class="txt1">Cold Brew</li>
<li class="txt2">콜드브루 전용 블렌드를 상온의 물로 오랜시간 추출해 달콤한 산미와 부드러운 바디감이 살아있는 커피</li>
</ul>
<dl class="info">
    <dt>제품 영양정보</dt>
    <dd class="info1">1회 제공량</dd>
    <dd class="info2">Regular</dd>
    <dd class="info3">354ml 기준 (Grande/472ml, Venti/591ml)</dd>
</dl>
...
<ul class="other1">
    ...
    <li class="other2_4"><a href="#">콜드브루</a></li>
    ...
    <li class="other1_4"><a href="latte_double.php">더블샷 바닐라 딜라이트</a></li>
</ul>
</section>
</div>
