...
<main id="main">
    ...
    <div class="bing3_wrap">
        ...
        <section class="bing3">
        <h2>1인) 애플망고빙수</h2>
        <p class="txt1">Apple Mango Iced Flakes</p>
        <p class="txt2">상큼한 요거트 아이스크림, 바삭한 코코넛칩과 망고가 <br>가득 올라가 풍성하게 즐길 수 있는 애플망고 빙수</p>
        <ul class="tag">
            <li class="new">NEW</li>
        ...
        <dt>제품 영양정보</dt>
            <dd class="info_txt">
                <ul>
                <li class="info1">총 중량 282g</li>
                <li class="info2">1회 제공량 282g</li>
                </ul>
            </dd>
            <dd class="agy">
                <ul>
                <li>알레르기 유발요인: 우유</li>
                <li>※ 식품위생법 표시기준에 의거하여 알레르기 표시항목에한해서만표기함</li>
                </ul>
            </dd>
            <dd>
                <table>
...
<div class="other_wrap de">
    ...
    <ul class="other1">
        ...
        <li class="other1_3"><a href="#">1인) 애플망고빙수</a></li>
