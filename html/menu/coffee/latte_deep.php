...
<div class="coffee3_wrap">
    <section class="coffee3">
    <h2>프리미엄 블렌드 딥라떼</h2>
    <ul>
    <li class="txt1">Premium Blend Deep Latte</li>
    <li class="txt2">풍성한 우유 거품 위에 프리미엄 블렌드 리스트레또 샷이 더해져<br> 깊은 커피 풍미를 느낄 수 있는 라떼</li>
    </ul>
    <dl class="info">
        <dt>제품 영양정보</dt>
...
<ul class="other1">
    ...
    <li class="other1_3"><a href="#">프리미엄 블렌드 딥 라떼</a></li>
