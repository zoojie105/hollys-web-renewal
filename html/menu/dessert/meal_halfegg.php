...
<main id="main">
    ...
    <div class="meal3_wrap">
        ...
        <section class="meal3">
        <h2>반반 마요(에그/감자)</h2>
        <p class="txt1">Half of Egg and Mashed Potato Mayo Sandwich</p>
        <p class="txt2">추억의 감자샐러드와 에그마요를 모두 즐길 수 있는 담백하고 산뜻한 샌드위치</p>
    
        <dl class="info">
        <dt>제품 영양정보</dt>
            <dd class="info_txt">
                <ul>
                <li class="info1">총 중량 285g</li>
                <li class="info2">1회 제공량 285g 기준</li>
                </ul>
            </dd>
            <dd>
                <table>
...
<div class="other_wrap de">
    ...
    <ul class="other1">
        ...
        <li class="other7_3"><a href="#">반반 마요<br>(에그/감자)</a></li>
