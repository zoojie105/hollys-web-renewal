...
<ul>
    ...
    <li class="tab5"><a href="#">회원정보 관리</a></li>
</ul>
</article>
</div>
...
<form name="edit1_form" action="edit_check.php" method="post" onsubmit="return form_check()">
<fieldset>
    <legend><img src="../../images/sub/Membership/my_hollys/tab5/title.jpg" alt="회원정보 관리"></legend>
    <p>비밀번호를 입력해주세요</p>
    <ul>
        <li class="txt1">아이디 <span><?php echo $s_id;?></span></li>
        <li>
    ...
    <div class="btn">
    <button type="submit" name="next">확인</button>
