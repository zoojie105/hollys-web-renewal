...
<main id="main">
    ...
    <div class="de15_wrap">
        ...
        <section class="de15">
        <h2>베이컨 에그 데니쉬</h2>
        <p class="txt1">Bacon Egg Danish</p>
        <p class="txt2">에그 데니쉬 안에 베이컨 한 줄을 그대로 넣어 더 든든하게 즐길 수 있는 베이커리</p>
    
        <dl class="info">
        <dt>제품 영양정보</dt>
            <dd class="info_txt">
                    <ul>
                    <li class="info1">총 중량 143g</li>
                    <li class="info2">1회 제공량 143g 기준</li>
                    </ul>
            </dd>
            <dd class="agy">
                    <ul>
                    <li>알레르기 유발요인: 밀, 계란, 우유, 대두, 돼지고기</li>
...
<div class="other_wrap de">
    ...
    <ul class="other1">
        ...
        <li class="other6_1"><a href="#">베이컨 에그 데니쉬</a></li>
