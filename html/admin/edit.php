...
<head>
    ...
    function del_mem(){
        ...
        if(ck){
            location.href="delete.php?idx=<?php echo $g_idx; ?>";
        };
    };
    </script>
</head>
...
<section class="modify_info">
    ...
    <h3>기본 정보</h3>
        ...
        <ul>
            ...
            <li class="th info5">
            <label for="level" class="txt3">회원 등급</label>
            <input type="text" name="level" id="level" value="<?php echo $array["level"];?>">
            </li>
        </ul>
    </div>
    ...
    <div class="modify_info2">
        ...
        <div class="btn_wrap_admin">
            <button type="submit" name="modify">수정</button>
            <button type="button" name="del" onclick="del_mem()">회원 삭제</button>
