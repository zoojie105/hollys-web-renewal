...
<div class="spa3_wrap">
    <aside class="locate">
        ...
        <ul>
            ...
            <li class="locate4"><a href="bev_spa.php">스파클링</a></li>
        </ul>
    </aside>
    
    <section class="spa3">
    <h2>자몽 파인 스파클링</h2>
    <p class="txt1">Grapefruit Pineapple Sparkling</p>
    <p class="txt2">세계 3대 광천수 초정리 탄산수와 자몽, 파인애플이 <br>상큼달콤하게 어우러진 스파클링 음료</p>
...
<div class="other_wrap bev">
    ...
    <ul class="other1">
        ...
        <li class="other6_4"><a href="#">자몽 파인<br>스파클링</a></li>
