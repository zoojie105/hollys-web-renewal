...
<div class="holy4_wrap">
    ...
    <section class="holy4">
    <h2>다크초코칩 할리치노</h2>
    <p class="txt1">Dark Chocochip Hollyccino</p>
    <p class="txt2">벨기에산 리얼 다크초콜릿이 씹히는 시원하고 진한 초콜릿 음료</p>
...
<div class="other_wrap bev">
    ...
    <ul class="other1">
        ...
        <li class="other8_1"><a href="#">다크초코칩<br>할리치노</a></li>
