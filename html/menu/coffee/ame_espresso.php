...
<article class="locate">
    ...
    <section class="coffee15">
    <h2>에스프레소</h2>
    <ul>
    <li class="txt1">Espresso</li>
    <li class="txt2">강렬한 첫 맛, 풍부한 바디감, 깔끔한 뒷 맛이 특징인 커피의 심장</li>
    </ul>
    <dl class="info">
        <dt>제품 영양정보</dt>
        <dd class="info1">1회 제공량</dd>
        <dd class="info2">Solo</dd>
        <dd class="info3">25ml 기준 (Dopio / 50ml)</dd>
    </dl>
...
<ul class="other1">
    ...
    <li class="other4_4"><a href="#">에스프레소</a></li>
