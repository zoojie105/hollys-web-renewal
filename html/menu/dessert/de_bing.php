...
<div class="bing">
    <aside class="locate">
        ...
        <ul>
            ...
            <li class="locate4"><a href="#">빙수</a></li>
    
        </ul>
    </aside>
    
    <section class="de_bing">
        <h2 class="blind">빙수</h2>
        <div class="bing1">
        <ul>
            <li class="bing1_1">
                <ul>
                <li><a href="">1인) 피치딸기빙수</a></li>
                <li class="new">NEW</li>
                </ul>
            </li>
            <li class="bing1_2">
                <ul>
                <li><a href="#">2인) 피치딸기빙수</a></li>
                <li class="new">NEW</li>
                </ul>
            </li>
            <li class="bing1_3">
                <ul>
                <li><a href="#">1인) 애플망고빙수</a></li>
                <li class="new">NEW</li>
                </ul>
            </li>
            <li class="bing1_4">
                <ul>
                <li><a href="#">2인) 애플망고빙수</a></li>
                <li class="new">NEW</li>
                </ul>
            </li>
            <li class="bing1_5">
                <ul>
                <li><a href="#">1인) 우리눈꽃<br>팥빙수</a></li>
                <li class="new">NEW</li>
                </ul>
            </li> 
        </ul>
