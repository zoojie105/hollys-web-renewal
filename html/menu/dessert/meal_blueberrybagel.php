...
<main id="main">
    ...
    <div class="meal18_wrap">
        ...
        <section class="meal18">
        <h2>블루베리 베이글 & 크림치즈</h2>
        <p class="txt1">Blueberry Bagel</p>
        <p class="txt2">플레인 베이글에 탱글탱글 달콤한 블루베리를 토핑한 제품</p>
    
        <dl class="info">
        <dt>제품 영양정보</dt>
            <dd class="info_txt">
                <ul>
                <li class="info1">총 중량 138g</li>
                <li class="info2">1회 제공량 138g 기준</li>
                </ul>
            </dd>
            <dd class="agy">
                <ul>
                <li>알레르기 유발요인: 밀, 우유</li>
...
<div class="other_wrap de">
    ...
    <ul class="other1">
        ...
        <li class="other11_4"><a href="#">블루베리 베이글 &<br>크림치즈</a></li>
